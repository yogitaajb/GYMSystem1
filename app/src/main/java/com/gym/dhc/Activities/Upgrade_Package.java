...
public class Upgrade_Package extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upgrade__package);
    ...
    public void PackageList(){
        StringRequest stringRequest = new StringRequest( Request.Method.POST, MyConfig.URL_UPGRADE_Package_List,
        ...
        RequestQueue queue = Volley.newRequestQueue(Upgrade_Package.this);
    ...
    private void getStatmentList(JSONArray j){
        ...
        mAdapter.setOnItemClickListener(new AdapterList.OnItemClickListener() {
            ...
            public void onItemClick(View view, Packages_model obj, int position) {
                ...
                /*Intent i = new Intent( Upgrade_Package.this, Make_Payment.class );
    ...
    private void showDialogImageQuotes(final Packages_model p) {
        final Dialog dialog = new Dialog(Upgrade_Package.this);
        ...
        et_personal_traning.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
               // showPersonalTraningDialog(v);
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Upgrade_Package.this);
        ...
        btn_make_payment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(p.getDescription().equalsIgnoreCase("Trail 3 Days")){
                    ...
                    android.app.AlertDialog.Builder alert = new android.app.AlertDialog.Builder(Upgrade_Package.this);
                        ...
                        if (coupon_code != null && !coupon_code.isEmpty() && !coupon_code.equals("null")) {
                            ...
                            try {
                                ...
                                if(data.matches( "success" )) {
                                    ...
                                    final AlertDialog.Builder builder = new AlertDialog.Builder(Upgrade_Package.this);
                        ...
                        if (coupon_code != null && !coupon_code.isEmpty() && !coupon_code.equals("null")) {
                            ...
                            try {
                                ...
                                if (data.matches("success")) {
                                    ...
                                    Intent i = new Intent(Upgrade_Package.this, Offline_Payment.class);
                                    i.putExtra("pack_id", p.getId());
                                    i.putExtra("pack_name", p.getPack_name());
                                    i.putExtra("pack_price", p.getPrice());
                                    i.putExtra("pack_desc", p.getDescription());
